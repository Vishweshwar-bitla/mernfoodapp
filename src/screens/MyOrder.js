                                                        ...
                                                        <div className=' col-12 col-md-6 col-lg-3' >
                                                            <div className="card mt-3" style={{ width: "16rem", maxHeight: "360px"  }}>
                                                                ...
                                                                <div className="card-body">
                                                                    ...
                                                                    <div className='container w-100 p-0' style={{ height: "auto" }}>
                                                                        ...
                                                                        <div style={{overflowY:"scroll", color:"red",width:"100%",height:"1.5rem",cursor:"default"}}>
                                                                            <span title={arrayData.custom} className='m-1' >{arrayData.custom}</span>

                                                                        </div>
                                                                        <span className='m-1'>{arrayData.nextweekday}</span>
                                                                    </div>
                                                                </div>
                                                            </div>
